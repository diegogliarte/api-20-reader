...
class ColorAnalyzer {
    ...
    fun analyzeMicrotubes(frame: Mat, microtubeRegions: List<Pair<Point, Point>>): List<List<MicrotubeColor>> {
    ...
    private fun getBestColors(microtube: Mat): List<MicrotubeColor> {
        ...
        val colorBoundsMap = mapOf(
            MicrotubeColor.RED to ColorBounds(Scalar(0.0, 100.0, 100.0), Scalar(10.0, 255.0, 255.0)),
